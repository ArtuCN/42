...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/21 15:10:19 by aconti            #+#    #+#             */
/*   Updated: 2023/12/13 15:23:59 by aconti           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	char_left = find_line(char_left, fd, 1);
	if (!char_left)
		return (NULL);
	result = getstr(char_left);
	char_left = final_function(char_left);
	if (!*result)
	{
		free(char_left);
		char_left = NULL;
